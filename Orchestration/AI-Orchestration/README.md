...
The AI-Orchestration module provides intelligent multi-agent coordination for complex AI tasks within the Unified AI Toolbox.
...
└── codex-multiagent-swarm/
    └── Orchestrate-Codex.ps1       # Multi-agent swarm orchestrator
```
...
**Usage:**
```powershell
.\codex-multiagent-swarm\Orchestrate-Codex.ps1 -RepoRoot . -MaxAgents 4
```
...
See the [prompt-api documentation](../UnifiedPromptApp/services/prompt-api/README.md) for more details.
...
2. **Unified Toolbox Webapp** (`apps/unifiedtoolbox.webapp`) - Integrated orchestrator page
...
```powershell
cd Orchestration/AI-Orchestration
