...
function ConvertTo-NormalizedAgentJson {
    ...
    $normalizedJson = $normalized | ConvertTo-Json -Depth 80

    if ($convertedDirectly -and ($candidate.Trim() -eq $normalizedJson.Trim())) {
