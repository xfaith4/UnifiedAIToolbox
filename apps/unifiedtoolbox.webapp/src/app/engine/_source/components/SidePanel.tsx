...
const SidePanel: React.FC<SidePanelProps> = ({ task, clearSelection, onShowDefinitions }) => {
  const panelWidth = task ? 'w-1/3' : 'w-0';

  return (
    <aside
      className={`bg-gray-800/80 backdrop-blur-lg border-l border-gray-700 transition-all duration-300 ease-in-out overflow-hidden ${panelWidth}`}
    >
