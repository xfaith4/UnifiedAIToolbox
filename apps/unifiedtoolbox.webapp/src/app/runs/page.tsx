...
import { History, ExternalLink, RefreshCw, Info } from 'lucide-react'
...
export default function RunsPage() {
  ...
  const totalCount = apiRuns.length + repoRuns.length + localRuns.length
    ...
    <div className="mx-auto max-w-5xl space-y-6">
      ...
      {!loading && totalCount === 0 && (
        <div className="rounded-2xl border border-gray-800 bg-gray-900/60 px-6 py-14 text-center">
          ...
          <p className="text-gray-400">No runs yet. Head to <Link href="/orchestrator" className="text-blue-400 underline">Playground</Link> or <Link href="/engine" className="text-blue-400 underline">App Factory</Link> to launch your first orchestration.</p>
        </div>
      )}
